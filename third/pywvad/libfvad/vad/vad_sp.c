...
void WebRtcVad_Downsampling(const int16_t* signal_in,
  ...
  for (n = 0; n < half_length; n++) {
    ...
    *signal_out = tmp16_1;
    ...
    // tmp16_1为Q(-1)
    // kAllPassCoefsQ13为Q13
    // 则(kAllPassCoefsQ13[0] * tmp16_1) * 2^(-12) 就为Q13*Q(-1)*Q12 = Q0了
...
int16_t WebRtcVad_FindMinimum(VadInstT* self,
  ...
  // 越界问题？
  // channel = 5, offset = 5*16
  // smallest_values[j+1]: j+1 = 5*16 + 15 + 1
  // 会越界，j+1的值还是在 VadInstT 结构体中
